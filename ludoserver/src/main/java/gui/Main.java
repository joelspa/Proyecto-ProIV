...
public class Main extends JFrame {
    ...
    private JLabel gameState = new JLabel("Game Status: Esperando mas jugadores...");
    ...
    public Main(int port, int players) throws UnknownHostException {
        ...
        numberOfPlayers = new JLabel("Número de jugadores: " + players);
    ...
    /**
     * Actualiza la vista cunado jugadores se conectan
     *
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                int serverPort = Integer.valueOf(JOptionPane.showInputDialog("Ingrese el puerto en el que se debe ejecutar el servidor.", "8888"));
